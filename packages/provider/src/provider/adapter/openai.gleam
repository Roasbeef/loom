...
/// the dialect's authentication header and nowhere else, and
/// `model.NoCredential` sends none at all, which is how an
/// extension-authenticated entry earns its first challenge.
///
