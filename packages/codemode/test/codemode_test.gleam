...
/// pinned to the one name it adds: `ext`, the vocabulary an extension's
/// tools and hooks are typed against, which carries no authority at all.
pub fn the_extension_seam_widens_by_exactly_one_name_test() {
  let extra =
