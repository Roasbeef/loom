...
import tui/model.{
  ...
  ApprovalInspector, Assistant, Attached, ControlEvent, DaemonSelector,
  DiffAutomatic, DiffHidden, DiffVisible, Disconnected, FrameCache,
  GoalInspector, HoldGoalReport, Line, Model, ModelSelector, Newer, NoClipboard,
  ...
  System, TerminalClipboard, ToolResult,
} as tui_model
