//// Terminal bootstrap delegates shared OS work through host/bootstrap.
////
//// Logger suppression, command passthrough, and VM exit remain terminal-owned.
//// The launch policy in tui/bootstrap keeps its existing types and call sites.

import gleam/result
import host/bootstrap as ffi
