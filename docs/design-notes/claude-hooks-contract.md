<!-- Pinned compatibility contract for issue #350. This is the Claude Code
hooks reference as served by https://code.claude.com/docs/en/hooks.md on
September 11, 2026, fetched verbatim. It is the document the hook parity
matrix in docs/architecture/hooks-compat.md is written against, and it
changes only by re-pinning the fetch date with the matrix, never by hand.
-->
> ## Documentation Index
