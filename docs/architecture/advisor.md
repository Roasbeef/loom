...
ledger (`strand_names`, `client/gateway.gleam:2516`). The advisor has
...
`advisor_payload` (`tui.gleam:6743`) extracts one of three
`AdvisorMessage` variants and `advisor_lines` (`tui.gleam:6834`) renders
