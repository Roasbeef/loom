...
`advisor_payload` (`tui.gleam:8034`) extracts one of three
`AdvisorMessage` variants and `advisor_lines` (`tui.gleam:8125`) renders
...
`parse_advisor` (`client/catalog.gleam:1532`) reads the `[advisor]`
