...
`advisor_payload` (`tui.gleam:7911`) extracts one of three
`AdvisorMessage` variants and `advisor_lines` (`tui.gleam:8002`) renders
...
`parse_advisor` (`client/catalog.gleam:1625`) reads the `[advisor]`
