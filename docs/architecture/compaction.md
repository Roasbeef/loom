...
once in `client/serve.gleam:569` (`default_reserve_tokens`) and
...
(`compaction_settings`, `client/serve.gleam:557`).
...
(`compaction_preparation`, `client/gateway.gleam:2357`). An
