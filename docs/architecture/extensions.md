...
(`extension_registrations` at `client/serve.gleam:1879`). A `Refused`
...
| `client/serve.gleam` | The boot that finds what is installed: `extension_registrations` (`client/serve.gleam:1879`), the two refusals it logs, and the contribution it appends. |
