...
and replaces strand-name
atoms with reference addresses; its local runtime suite passes 109 tests,
including a 1,000-strand atom-growth check. Session-service names, cleanup
