...
`handle_text` becomes `dispatch` (`client/gateway.gleam:2750`), which
...
The hint carries nothing. It triggers `pull` (`client/gateway.gleam:1988`),
...
`reply_with_matched` (`client/gateway.gleam:3471`) pulls, picks the last
