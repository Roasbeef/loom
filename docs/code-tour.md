...
`handle_text` becomes `dispatch` (`client/gateway.gleam:3159`), which
...
The hint carries nothing. It triggers `pull` (`client/gateway.gleam:2324`),
...
`reply_with_matched` (`client/gateway.gleam:4153`) pulls, picks the last
