...
`handle_text` becomes `dispatch` (`client/gateway.gleam:3637`), which
...
The hint carries nothing. It triggers `pull` (`client/gateway.gleam:2770`),
...
`reply_with_matched` (`client/gateway.gleam:5399`) pulls, picks the last
