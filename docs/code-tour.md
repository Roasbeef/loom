...
`handle_text` becomes `dispatch` (`client/gateway.gleam:3178`), which
...
The hint carries nothing. It triggers `pull` (`client/gateway.gleam:2343`),
...
`reply_with_matched` (`client/gateway.gleam:4172`) pulls, picks the last
