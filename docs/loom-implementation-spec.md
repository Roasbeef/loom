...
[Protocol 033](../protocol-change/033-provider-challenge.md) adds
`Challenged` and `ChallengeUnanswered` for a provider entry whose credential
comes from an extension; both are terminal beneath `WithContext`.
